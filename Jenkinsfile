	...
	stage('Deploy to Target Server') {
            steps {
                script {
                    ...
                    sh 'ssh roja1998/register-app-pipeline "docker pull register-app-pipeline:latest"' 
			sh 'ssh roja1998/register-app-pipeline "docker run -d register-app-pipeline:latest"'
                }
            }
        }   
   }
